...
public class CreateBeanApp {
	public static void main(String[] args) {
		...
		BeanFactory factory = new XmlBeanFactory(new FileSystemResource("src/main/resources/04_1_beanCreate.xml"));
		...
		ApplicationContext context = new ClassPathXmlApplicationContext("04_1_beanCreate.xml");
		System.out.println("=============== Spring Container 초기화 후 ===============");
