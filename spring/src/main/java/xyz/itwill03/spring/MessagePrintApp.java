...
public class MessagePrintApp {
	public static void main(String[] args) {
		/*
		 * HelloMessageObject object = new HelloMessageObject(); MessagePrint print =
		 * new MessagePrint(); print.setObject(object); // 객체 필드에 객체를 전달하여 저장 - 포함관계 완성
		 * print.messagePrint();
		 */

		// ApplicationContext 객체 : Spring Container 기능을 제공하기 위한 객체
		// => Spring Bean Configuration File(XML)을 제공받아 객체(SpringBean)를 생성
